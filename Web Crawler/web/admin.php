...
<body>
    ...
    <div class="centered">
      <form action="htmlParse.php" method="get">
        <input type="text" name="term" id="searchBox" required="true">
        <input type="submit" value="Parse" id="myButton"/>
      </form>
    </div>
    <div class="centered">
     
      <form action="my-search.php">
        <input type="submit" id="switch" value='To Search' class="btn btn-primary">
      </form>
    </div>
    </div>
  </div>
